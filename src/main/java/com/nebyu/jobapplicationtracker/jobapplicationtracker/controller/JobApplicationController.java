...
import com.nebyu.jobapplicationtracker.jobapplicationtracker.service.JobApplicationService;
...
public class JobApplicationController {
    ...
    @PostMapping("/create")
    public ResponseEntity<String> createJobApplication(@RequestBody JobApplication jobApplication, @RequestParam Long userId) {
